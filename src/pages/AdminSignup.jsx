    ...
    <div className="bg-gradient-to-br from-pink-100 to-blue-100 min-h-screen flex flex-col">
      ...
      <div className="flex items-center justify-center min-h-[80vh] flex-1 mt-10">
        <form onSubmit={handleSubmit} className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100 w-full max-w-md flex flex-col gap-6">
          <h2 className="text-3xl font-extrabold mb-2 text-center text-pink-600">Admin Sign Up</h2>
          <div className="mb-2">
            <label className="block mb-1 font-medium text-gray-700">Admin Username</label>
            <input
              type="text"
              value={username}
          ...
          <div className="mb-2">
            <label className="block mb-1 font-medium text-gray-700">Admin Name</label>
            <input
              type="text"
              value={name}
          ...
          <p className="text-center text-gray-600 mt-4">
            Already have an Admin account? <a href="/login" className="text-pink-600 hover:underline">Login</a>
          </p>
